<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCompletedTakingOrder.aspx.cs" Inherits="WebPages.MyCompletedTakingOrder" %>
	...
	<div class="location">
		<div class="container">
				<div class="locat-left">
				    ...
				    <asp:Label ID="Label1" runat="server" Text="已接完成的配送订单"></asp:Label>
                ...
                <div class="locat-right">
				    ...
				    <asp:GridView ID="GridView1" runat="server" CellPadding="3" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TakeEndDateTime" HeaderText="订单结束时间" />
                        </Columns>
                    ...
                    SelectMethod="getDataToGridView6" TypeName="WebPages.GridViewShow6">
